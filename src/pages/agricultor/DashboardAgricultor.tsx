...
export const DashboardAgricultor = () => {
  ...
  const estadisticas = [
    ...
    },
    {
      ...
      valor: terrenos.length > 0 ? Math.round(terrenos.reduce((acc, t) => acc + t.temperatura, 0) / terrenos.length) + '°C' : '0°C',
      icono: Sun,
      ...
      <main className="flex-1 overflow-auto">
        ...
        >
          ...
          <p className="text-gray-600 mt-2">
            Aquí puedes gestionar tus terrenos y monitorear el clima en tiempo real
          </p>
        </motion.div>
                      ...
                      <div className="p-4 space-y-3">
                        <div className="grid grid-cols-3 gap-2 text-center">
                          <div className="bg-green-50 rounded-lg p-2">
                            ...
                            <p className="text-sm font-bold">{terreno.temperatura}°C</p>
                            <p className="text-xs text-gray-600">Temperatura</p>
                          </div>
                          <div className="bg-green-50 rounded-lg p-2">
                            <p className="text-2xl">💧</p>
                            <p className="text-sm font-bold">{terreno.humedad}%</p>
                            <p className="text-xs text-gray-600">Humedad</p>
                          </div>
                          <div className="bg-green-50 rounded-lg p-2">
                            <p className="text-2xl">💨</p>
                            <p className="text-sm font-bold">{terreno.viento}km/h</p>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-white rounded-2xl p-8 shadow-md border border-gray-100">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Agricultor Premium</p>
                </div>

                {/* Preferences */}
                <div className="space-y-4 mb-8">
                  <h4 className="font-bold text-gray-800">Preferencias de Notificaciones</h4>
                  <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition">
                    ...
                    />
                    <span className="text-gray-700">Alertas de clima extremo</span>
                  </label>
                  <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition">
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition">
                    <input
                      ...
                      className="w-4 h-4 text-green-600"
                    />
                    <span className="text-gray-700">Recomendaciones de riego</span>
                  </label>
                </div>

    ...
    >
      ...
      <nav className="flex-1 px-3 py-6 space-y-2 overflow-y-auto">
        ...
        >
          ...
          {sidebarOpen && (
            <span className="flex-1 text-left text-sm font-medium">Inicio</span>
          )}
        </motion.button>
        ...
        <motion.button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-gray-300 hover:text-white hover:bg-green-700 group"
          title={!sidebarOpen ? 'Nuevo Terreno' : ''}
        >
          <Plus className="w-5 h-5 shrink-0 group-hover:text-green-300" />
          {sidebarOpen && (
            <span className="flex-1 text-left text-sm font-medium">Nuevo Terreno</span>
          )}
        </motion.button>
        ...
        <motion.button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all text-gray-300 hover:text-white hover:bg-green-700 group"
          title={!sidebarOpen ? 'Mis Terrenos' : ''}
        >
          <MapPin className="w-5 h-5 shrink-0 group-hover:text-green-300" />
          {sidebarOpen && (
            <span className="flex-1 text-left text-sm font-medium">Mis Terrenos</span>
          )}
        </motion.button>
        ...
        >
          ...
          {sidebarOpen && (
            <span className="flex-1 text-left text-sm font-medium">Perfil</span>
          )}
        </motion.button>
      </nav>
